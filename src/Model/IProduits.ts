export interface alimentaireType {   id: number , libelle: string ,  typep: number ,  poids: number  , image: string  , cargaison: number }
export interface chimiqueType {   id: number , libelle: string ,  typep: number ,  poids: number  , image: string  , cargaison: number,  toxicite: number }
